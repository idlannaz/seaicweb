<?php include('backend/pages/confBE.inc.php'); ?>
...
<div class="row">
  ...
  <div class="rightcolumn sticky">
    <div class="card">
        <h3 class="left" style="font-size: x-large;">What is SEAIC-CONFERENCES?</h3>
      <h5 class="left" style="font-size: large;">Conference page is for the events that SEAIC held that can be participate.</h5>
    </div>
