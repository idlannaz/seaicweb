<?php
  ...
  $sql = "SELECT * FROM page INNER JOIN post ON post.pageID = page.pageID INNER JOIN image ON image.postID = post.postID WHERE post.pageID = 2 ORDER BY post.time desc";
  ...
  if (isset($_POST['post'])) { 
    ...
    echo "<script language='javascript'>alert('Post added successfully.');window.location='csr.php';</script>";
  }
